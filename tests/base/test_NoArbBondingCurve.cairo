...
func test_bondingCurveSellBuyNoProfit{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr: felt}(
    ...
    let (delta) = Curve.modifySpotPrice(_deltaUint);

    let (numItems, _) = uint256_unsigned_div_rem(Uint256(low=_numItems, high=0), Uint256(low=3, high=0));
...
// @external
// func test_bondingCurveSellBuyNoProfitErr{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr: felt}() {
//     alloc_locals;
...
//     let _spotPrice = 52599;
//     let _delta = 18446744073709551615;
//     let _numItems = 116;
