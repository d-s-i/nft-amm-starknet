...
from contracts.pairs.NFTPairMissingEnumerableERC20.library import (NFTPairMissingEnumerableERC20)
...
//
// NFTPairMissingEnumerableERC20 FUNCTIONS
//
...
func swapTokenForAnyNFTs{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr: felt}(
    ...
    NFTPairMissingEnumerableERC20._sendAnyNFTsToRecipient(_nftAddress, nftRecipient, Uint256(low=0, high=0), numNFTs);
...
func swapTokenForSpecificNFTs{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr: felt}(
    ...
    NFTPairMissingEnumerableERC20._sendSpecificNFTsToRecipient(
        _nftAddress,
        nftRecipient,
        0,
        nftIds_len,
...
func onERC721Received{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr: felt}(
    ...
    let (selector) = NFTPairMissingEnumerableERC20.onERC721Received(
        collectionAddress,
        operator, 
        from_, 
        tokenId, 
