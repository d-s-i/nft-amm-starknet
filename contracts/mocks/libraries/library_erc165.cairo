...
// OpenZeppelin Contracts for Cairo v0.5.0 (introspection/erc165/library.cairo)
...
from contracts.tests.libraries.library_constants import (INVALID_ID, IERC165_ID)
